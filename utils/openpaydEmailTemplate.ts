...
export const getOpenpaydEmailTemplate = (data: any, lang?: string) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Openpayd</title>
    <style>
        * {
        ...
        .header {
            ...
            background-image: linear-gradient(to right, #0052FF, #0A2540);
            padding: 14px 20px;
            display: flex;
            align-items: center;
...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
    ...
    <div class="email-container">
            <div class="header" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                ${(() => {
                    const logoUrl = resolveLogoUrl(data.logo_url, '/openpayd-logo.png');
                    return logoUrl
                        ? `<img src="${logoUrl}" alt="Openpayd" class="logo" style="width: 85px; height: auto; background: transparent; margin-right: 40px;">`
                        : `<img src="/openpayd-logo.png" alt="Openpayd" class="logo" style="width: 85px; height: auto; margin-right: 40px;" onerror="this.style.display='none'">`;
                })()}
                <div class="bank-info" style="text-align: right;">
                    <div class="bank-name">Openpayd Bank</div>
                    <div><span style="color: #ffffff !important; text-decoration: none !important;">The Bower, 207 Old Street, London EC1V 9NR, UK</span></div>
            ...
            <div class="security-section">
                ...
                <p style="margin: 0;">${t('security_notice_text', lang).replace('{bank}', 'Openpayd Bank')}</p>
            </div>

            <div style="font-size: 10px; color: #666666; text-align: center; border-top: 1px solid #dddddd; padding-top: 10px;">
                <p style="margin: 0 0 4px 0;">${t('automated_notification', lang).replace('{bank}', 'Openpayd Bank')}</p>
                <p style="margin: 0 0 4px 0;">&copy; ${new Date().getFullYear()} Openpayd Bank. ${t('all_rights_reserved', lang)}.</p>
            </div>
            </div>
        </div>
</body>
