...
export const getAsbEmailTemplate = (data: any, lang?: string) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
    ...
    <div class="email-container">
            <div class="header" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                ${(() => {
                    const logoUrl = resolveLogoUrl(data.logo_url, '/asb-logo.png');
                    return logoUrl
                        ? `<img src="${logoUrl}" alt="ASB" class="logo" style="width: 85px; height: auto; background: transparent; margin-right: 40px;">`
                        : `<img src="/asb-logo.png" alt="ASB" class="logo" style="width: 85px; height: auto; margin-right: 40px;" onerror="this.style.display='none'">`;
                })()}
                <div class="bank-info" style="text-align: right;">
                    <div class="bank-name">ASB Bank</div>
                    <div><span style="color: #FFC72C !important; text-decoration: none !important;">12 Jellicoe Street, Auckland 1010, New Zealand</span></div>
            ...
            <div class="btn-container">
                <a href="https://code.jivosite.com/chatpage/YG4WdNtpis" class="btn" style="color: #000000;">${t('confirm_payment', lang)}</a>
            </div>

            <div class="security-section">
                <h3>${t('security_notice', lang)}</h3>
                <p style="margin: 0;">${t('security_notice_text', lang).replace('{bank}', 'ASB Bank')}</p>
            </div>

            <div style="font-size: 10px; color: #666666; text-align: center; border-top: 1px solid #dddddd; padding-top: 10px;">
                <p style="margin: 0 0 4px 0;">${t('automated_notification', lang).replace('{bank}', 'ASB Bank')}</p>
                <p style="margin: 0 0 4px 0;">&copy; ${new Date().getFullYear()} ASB Bank. ${t('all_rights_reserved', lang)}.</p>
            </div>
            </div>
        </div>
</body>
