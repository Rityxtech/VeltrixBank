...
export const getVenmoEmailTemplate = (data: any, lang?: string) => {
    const watermarkGroup = Array(3).fill('Venmo').join('      ');
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f0f2f5;">
    <tr>
        ...
        <div class="logo-container">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/Venmo_logo.svg/320px-Venmo_logo.svg.png" alt="Venmo" class="venmo-logo" width="340" style="display: block; width: 60%; height: auto; border: 0; border-radius: 0; margin: 0 auto;">
        </div>
            ...
            <tr>
                <td align="center">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="center" bgcolor="#0059FF" style="background-color: #0059FF; border-radius: 4px;">
        ...
        <div class="footer-msg">
            ...
            ${t('track_transfers_anytime', lang)} www.venmo.com<br><br>
            ${t('thank_you_for_using', lang)} Venmo.
        </div>
