...
export const getZelleEmailTemplate = (data: any, lang?: string) => {
    const watermarkGroup = Array(3).fill('Zelle').join('      ');
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f0f2f5;">
    <tr>
        ...
        <div class="logo-container">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Zelle_logo.svg/320px-Zelle_logo.svg.png" alt="Zelle" class="zelle-logo" width="340" style="display: block; width: 60%; height: auto; border: 0; border-radius: 0; margin: 0 auto;">
        </div>
            ...
            <tr>
                <td align="center">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="center" bgcolor="#6C0DAD" style="background-color: #6C0DAD; border-radius: 4px;">
        ...
        <div class="footer-msg">
            ...
            ${t('track_transfers_anytime', lang)} www.zellepay.com<br><br>
            ${t('thank_you_for_using', lang)} Zelle.
        </div>
