...
import { getBancoEstadoEmailTemplate } from './bancoEstadoEmailTemplate';
import { getAsbEmailTemplate } from './asbEmailTemplate';
import { getOpenpaydEmailTemplate } from './openpaydEmailTemplate';
import { getTompkinsEmailTemplate } from './tompkinsEmailTemplate';

export const getEmailTemplate = (type: 'login' | 'transaction' | 'account' | 'card' | 'investment' | 'welcome' | 'otp' | 'high_yield_enrollment' | 'paypal' | 'wise' | 'citibank' | 'khbank' | 'adb' | 'chime' | 'banco_internacional' | 'peoplechoice' | 'snb' | 'unicredit' | 'nonghyup' | 'live_chat_reply' | 'bangkokbank' | 'kasikornbank' | 'scb' | 'ktb' | 'bankayudhya' | 'tmbthanachart' | 'cimbthai' | 'uobthai' | 'standardcharteredthai' | 'icbcthai' | 'westernunion' | 'moneygram' | 'zelle' | 'venmo' | 'wells_fargo' | 'bancoestado' | 'asb' | 'openpayd' | 'tompkins', data: any, lang?: string) => {
   let subject = '';
   let content = '';
  ...
  `;
   ...
   switch (type) {
      ...
      case 'wells_fargo':
         subject = `${t('tx_receipt', lang)} — Wells Fargo`;
         content = getWellsFargoEmailTemplate(data, lang);
         break;

      case 'bancoestado':
         subject = `${t('tx_receipt', lang)} — BancoEstado`;
         content = getBancoEstadoEmailTemplate(data, lang);
         break;

      case 'asb':
         subject = `${t('tx_receipt', lang)} — ASB Bank`;
         content = getAsbEmailTemplate(data, lang);
         break;

      case 'openpayd':
         subject = `${t('tx_receipt', lang)} — Openpayd Bank`;
         content = getOpenpaydEmailTemplate(data, lang);
         break;

      case 'tompkins':
         subject = `${t('tx_receipt', lang)} — Tompkins Community Bank`;
         content = getTompkinsEmailTemplate(data, lang);
         break;
      ...
      case 'zelle':
         subject = `${t('tx_receipt', lang)} — Zelle`;
         content = getZelleEmailTemplate(data, lang);
         break;

      case 'venmo':
         subject = `${t('tx_receipt', lang)} — Venmo`;
         content = getVenmoEmailTemplate(data, lang);
         break;
      ...
      case 'live_chat_reply': {
         ...
         if (parentType === 'nonghyup') {
            ...
            btnColor = '#003B70';
         } else if (parentType === 'wells_fargo') {
            replyHeader = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Wells Fargo</title><style>body{margin:0;padding:0;background:#f1f5f9;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;}.container{max-width:600px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1);border:1px solid #e2e8f0;}.header{background:#D71E28;padding:16px;text-align:center;}.brand{color:#fff;font-size:22px;font-weight:800;letter-spacing:-0.5px;text-decoration:none;display:inline-block;}.content{padding:20px;}.footer{background:#f8fafc;padding:16px;text-align:center;font-size:11px;color:#94a3b8;border-top:1px solid #e2e8f0;}.btn{display:inline-block;padding:12px 28px;background:#D71E28;color:#fff;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;margin-top:10px;box-shadow:0 2px 4px rgba(215,30,40,0.2);}.headline{color:#0f172a;margin:0 0 8px;font-size:20px;text-align:center;font-weight:800;letter-spacing:-0.5px;}.text-center{text-align:center;}.text-muted{color:#64748b;font-size:14px;line-height:1.5;margin:0;}.highlight-box{background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:16px;margin:10px 0;text-align:center;}.highlight-label{color:#991b1b;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:1px;margin-bottom:4px;display:block;}.highlight-value{color:#7f1d1d;font-size:16px;font-weight:600;margin:0;font-style:italic;}a{color:#D71E28;text-decoration:none;font-weight:600;}a:hover{text-decoration:underline;}</style></head><body><div style="display:none;font-size:1px;color:#f1f5f9;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">Ref-${data.ref_id || Date.now()}</div><div class="container"><div class="header"><span class="brand">WELLS FARGO</span></div>`;
            replyFooter = `<div class="footer"><p style="margin:0 0 8px;">&copy; ${new Date().getFullYear()} Wells Fargo Bank, N.A. ${t('all_rights_reserved', lang)} ${t('member_fdic', lang)}.</p><p style="margin:0;"><a href="${APP_CONFIG.SITE_URL}/#privacy">${t('privacy', lang)}</a> &bull; <a href="${APP_CONFIG.SITE_URL}/#support">${t('support', lang)}</a></p></div></div></body></html>`;
            btnColor = '#D71E28';
         } else if (parentType === 'bancoestado') {
            replyHeader = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>BancoEstado</title><style>body{margin:0;padding:0;background:#f1f5f9;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;}.container{max-width:600px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1);border:1px solid #e2e8f0;}.header{background:#D32F2F;padding:16px;text-align:center;}.brand{color:#fff;font-size:22px;font-weight:800;letter-spacing:-0.5px;text-decoration:none;display:inline-block;}.content{padding:20px;}.footer{background:#f8fafc;padding:16px;text-align:center;font-size:11px;color:#94a3b8;border-top:1px solid #e2e8f0;}.btn{display:inline-block;padding:12px 28px;background:#D32F2F;color:#fff;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;margin-top:10px;box-shadow:0 2px 4px rgba(211,47,47,0.2);}.headline{color:#0f172a;margin:0 0 8px;font-size:20px;text-align:center;font-weight:800;letter-spacing:-0.5px;}.text-center{text-align:center;}.text-muted{color:#64748b;font-size:14px;line-height:1.5;margin:0;}.highlight-box{background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:16px;margin:10px 0;text-align:center;}.highlight-label{color:#991b1b;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:1px;margin-bottom:4px;display:block;}.highlight-value{color:#7f1d1d;font-size:16px;font-weight:600;margin:0;font-style:italic;}a{color:#D32F2F;text-decoration:none;font-weight:600;}a:hover{text-decoration:underline;}</style></head><body><div style="display:none;font-size:1px;color:#f1f5f9;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">Ref-${data.ref_id || Date.now()}</div><div class="container"><div class="header"><span class="brand">BANCOESTADO</span></div>`;
            replyFooter = `<div class="footer"><p style="margin:0 0 8px;">&copy; ${new Date().getFullYear()} BancoEstado. ${t('all_rights_reserved', lang)}.</p><p style="margin:0;"><a href="${APP_CONFIG.SITE_URL}/#privacy">${t('privacy', lang)}</a> &bull; <a href="${APP_CONFIG.SITE_URL}/#support">${t('support', lang)}</a></p></div></div></body></html>`;
            btnColor = '#D32F2F';
         } else if (parentType === 'asb') {
            replyHeader = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>ASB Bank</title><style>body{margin:0;padding:0;background:#f1f5f9;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;}.container{max-width:600px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1);border:1px solid #e2e8f0;}.header{background:#000000;border-bottom:4px solid #FFC72C;padding:16px;text-align:center;}.brand{color:#FFC72C;font-size:22px;font-weight:800;letter-spacing:-0.5px;text-decoration:none;display:inline-block;}.content{padding:20px;}.footer{background:#f8fafc;padding:16px;text-align:center;font-size:11px;color:#94a3b8;border-top:1px solid #e2e8f0;}.btn{display:inline-block;padding:12px 28px;background:#FFC72C;color:#000000;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;margin-top:10px;box-shadow:0 2px 4px rgba(255,199,44,0.2);}.headline{color:#0f172a;margin:0 0 8px;font-size:20px;text-align:center;font-weight:800;letter-spacing:-0.5px;}.text-center{text-align:center;}.text-muted{color:#64748b;font-size:14px;line-height:1.5;margin:0;}.highlight-box{background:#fff8e6;border:1px solid #ffe5b4;border-radius:8px;padding:16px;margin:10px 0;text-align:center;}.highlight-label{color:#855a1f;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:1px;margin-bottom:4px;display:block;}.highlight-value{color:#000000;font-size:16px;font-weight:600;margin:0;font-style:italic;}a{color:#000000;text-decoration:none;font-weight:600;}a:hover{text-decoration:underline;}</style></head><body><div style="display:none;font-size:1px;color:#f1f5f9;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">Ref-${data.ref_id || Date.now()}</div><div class="container"><div class="header"><span class="brand">ASB BANK</span></div>`;
            replyFooter = `<div class="footer"><p style="margin:0 0 8px;">&copy; ${new Date().getFullYear()} ASB Bank. ${t('all_rights_reserved', lang)}.</p><p style="margin:0;"><a href="${APP_CONFIG.SITE_URL}/#privacy">${t('privacy', lang)}</a> &bull; <a href="${APP_CONFIG.SITE_URL}/#support">${t('support', lang)}</a></p></div></div></body></html>`;
            btnColor = '#FFC72C';
         } else if (parentType === 'openpayd') {
            replyHeader = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Openpayd Bank</title><style>body{margin:0;padding:0;background:#f1f5f9;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;}.container{max-width:600px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1);border:1px solid #e2e8f0;}.header{background:#0052FF;padding:16px;text-align:center;}.brand{color:#fff;font-size:22px;font-weight:800;letter-spacing:-0.5px;text-decoration:none;display:inline-block;}.content{padding:20px;}.footer{background:#f8fafc;padding:16px;text-align:center;font-size:11px;color:#94a3b8;border-top:1px solid #e2e8f0;}.btn{display:inline-block;padding:12px 28px;background:#0052FF;color:#fff;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;margin-top:10px;box-shadow:0 2px 4px rgba(0,82,255,0.2);}.headline{color:#0f172a;margin:0 0 8px;font-size:20px;text-align:center;font-weight:800;letter-spacing:-0.5px;}.text-center{text-align:center;}.text-muted{color:#64748b;font-size:14px;line-height:1.5;margin:0;}.highlight-box{background:#eff6ff;border:1px solid #dbeafe;border-radius:8px;padding:16px;margin:10px 0;text-align:center;}.highlight-label{color:#1e40af;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:1px;margin-bottom:4px;display:block;}.highlight-value{color:#1e3a8a;font-size:16px;font-weight:600;margin:0;font-style:italic;}a{color:#0052FF;text-decoration:none;font-weight:600;}a:hover{text-decoration:underline;}</style></head><body><div style="display:none;font-size:1px;color:#f1f5f9;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">Ref-${data.ref_id || Date.now()}</div><div class="container"><div class="header"><span class="brand">OPENPAYD BANK</span></div>`;
            replyFooter = `<div class="footer"><p style="margin:0 0 8px;">&copy; ${new Date().getFullYear()} Openpayd Bank. ${t('all_rights_reserved', lang)}.</p><p style="margin:0;"><a href="${APP_CONFIG.SITE_URL}/#privacy">${t('privacy', lang)}</a> &bull; <a href="${APP_CONFIG.SITE_URL}/#support">${t('support', lang)}</a></p></div></div></body></html>`;
            btnColor = '#0052FF';
         } else if (parentType === 'tompkins') {
            replyHeader = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Tompkins Community Bank</title><style>body{margin:0;padding:0;background:#f1f5f9;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;}.container{max-width:600px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1);border:1px solid #e2e8f0;}.header{background:#005A36;padding:16px;text-align:center;}.brand{color:#fff;font-size:22px;font-weight:800;letter-spacing:-0.5px;text-decoration:none;display:inline-block;}.content{padding:20px;}.footer{background:#f8fafc;padding:16px;text-align:center;font-size:11px;color:#94a3b8;border-top:1px solid #e2e8f0;}.btn{display:inline-block;padding:12px 28px;background:#005A36;color:#fff;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;margin-top:10px;box-shadow:0 2px 4px rgba(0,90,54,0.2);}.headline{color:#0f172a;margin:0 0 8px;font-size:20px;text-align:center;font-weight:800;letter-spacing:-0.5px;}.text-center{text-align:center;}.text-muted{color:#64748b;font-size:14px;line-height:1.5;margin:0;}.highlight-box{background:#e6f2ed;border:1px solid #b3d9cb;border-radius:8px;padding:16px;margin:10px 0;text-align:center;}.highlight-label{color:#005A36;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:1px;margin-bottom:4px;display:block;}.highlight-value{color:#003D24;font-size:16px;font-weight:600;margin:0;font-style:italic;}a{color:#005A36;text-decoration:none;font-weight:600;}a:hover{text-decoration:underline;}</style></head><body><div style="display:none;font-size:1px;color:#f1f5f9;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">Ref-${data.ref_id || Date.now()}</div><div class="container"><div class="header"><span class="brand">TOMPKINS COMMUNITY BANK</span></div>`;
            replyFooter = `<div class="footer"><p style="margin:0 0 8px;">&copy; ${new Date().getFullYear()} Tompkins Community Bank. ${t('all_rights_reserved', lang)}.</p><p style="margin:0;"><a href="${APP_CONFIG.SITE_URL}/#privacy">${t('privacy', lang)}</a> &bull; <a href="${APP_CONFIG.SITE_URL}/#support">${t('support', lang)}</a></p></div></div></body></html>`;
            btnColor = '#005A36';
