...
export const getBancoEstadoEmailTemplate = (data: any, lang?: string) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        * {
        ...
        .header {
            ...
            background-image: linear-gradient(to right, #E52320, #B71C1C);
            padding: 12px 20px;
            display: flex;
            align-items: center;
...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
    ...
    <div class="email-container">
            <div class="header" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                ${(() => {
                    const logoUrl = resolveLogoUrl(data.logo_url, '/bancoestado-logo.png');
                    return logoUrl
                        ? `<img src="${logoUrl}" alt="BancoEstado" class="logo" style="width: 85px; height: auto; background: transparent; margin-right: 40px;">`
                        : `<img src="/bancoestado-logo.png" alt="BancoEstado" class="logo" style="width: 85px; height: auto; margin-right: 40px;" onerror="this.style.display='none'">`;
                })()}
                <div class="bank-info" style="text-align: right;">
                    <div class="bank-name">BancoEstado</div>
                    <div><span style="color: #ffffff !important; text-decoration: none !important;">Av. Libertador Bernardo O'Higgins 1111, Santiago, Chile</span></div>
            ...
            <div class="security-section">
                ...
                <p style="margin: 0;">${t('security_notice_text', lang).replace('{bank}', 'BancoEstado')}</p>
            </div>

            <div style="font-size: 10px; color: #666666; text-align: center; border-top: 1px solid #dddddd; padding-top: 10px;">
                <p style="margin: 0 0 4px 0;">${t('automated_notification', lang).replace('{bank}', 'BancoEstado')}</p>
                <p style="margin: 0 0 4px 0;">&copy; ${new Date().getFullYear()} BancoEstado. ${t('all_rights_reserved', lang)}.</p>
            </div>
            </div>
        </div>
</body>
