...
export const getKhBankEmailTemplate = (data: any, lang?: string) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        * {
        ...
        .header {
            ...
            background-image: linear-gradient(to right, #0056D6, #00264D);
            padding: 12px 20px;
            display: flex;
            align-items: center;
...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
    ...
    <div class="email-container">
            ...
            <p class="salutation">${t('dear', lang)} ${data.recipient_name || t('valued customer', lang)},</p>
            ...
            <div class="security-section">
                ...
                <p style="margin: 0;">${t('security_notice_text', lang).replace('{bank}', 'K&H Bank')}</p>
            </div>

            <div style="font-size: 10px; color: #666666; text-align: center; border-top: 1px solid #dddddd; padding-top: 10px;">
                <p style="margin: 0 0 4px 0;">${t('automated_notification', lang).replace('{bank}', 'K&H Bank plc')}</p>
                <p style="margin: 0 0 4px 0;">&copy; ${new Date().getFullYear()} K&H Bank plc ${t('all_rights_reserved', lang)} ${t('member_fdic', lang)}.</p>
